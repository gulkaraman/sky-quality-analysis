...
Bu proje, gökyüzü görüntülerinden **bulutluluk (cloudiness)** oranını hesaplayan ve gözlem kalitesini takip etmek için **CSV rapor** + **grafik** çıktıları üreten Python tabanlı bir analiz pipeline’ıdır.  
